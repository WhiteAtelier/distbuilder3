...
#include "roah/distb/config/option_value.hpp"

#include <algorithm>
#include <stdexcept>

roah::distb::config::OptionValue::OptionValue()
    : value_{ std::string{} }
{}

roah::distb::config::OptionValue::OptionValue(std::string value)
    : value_{ std::move(value) }
{}

roah::distb::config::OptionValue::OptionValue(const bool value)
    : value_{ value }
{}

roah::distb::config::OptionValue::OptionValue(const std::int64_t value)
    : value_{ value }
{}

roah::distb::config::OptionValue::OptionValue(const double value)
    : value_{ value }
{}

roah::distb::config::OptionValue::OptionValue(const OptionValue &)     = default;
roah::distb::config::OptionValue::OptionValue(OptionValue &&) noexcept = default;

roah::distb::config::OptionValue &
roah::distb::config::OptionValue::operator=(const OptionValue &)
    = default;

roah::distb::config::OptionValue &
roah::distb::config::OptionValue::operator=(OptionValue &&) noexcept
    = default;

roah::distb::config::OptionValue::~OptionValue() = default;

bool
roah::distb::config::OptionValue::operator==(const OptionValue & other) const
{
...
roah::distb::config::OptionValue::operator std::string() const
{
...
roah::distb::config::OptionValue::operator bool() const
{
    if (std::holds_alternative<bool>(this->value_))
    {
...
roah::distb::config::OptionValue::operator std::int64_t() const
{
    if (!std::holds_alternative<std::int64_t>(this->value_))
    {
...
roah::distb::config::OptionValue::operator double() const
{
    if (!std::holds_alternative<double>(this->value_))
    {
